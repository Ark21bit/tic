<template>
    <div class="flex items-center gap-[3px]">
        <button type="button" @click="count--" class="text-fblack bg-[#F4F4F4] p-[5px] aspect-square rounded-[5px] hover:text-white hover:bg-fred transition-colors ease-linear duration-500"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="1" viewBox="0 0 13 1" fill="none"><rect x="13" y="1" width="13" height="0.999999" rx="0.499999" transform="rotate(-180 13 1)" fill="currentColor"/></svg></button>
        <input type="number" v-model="count" class="flex items-center focus:border-fline focus:ring-transparent justify-center text-fblack h-[23px] border border-fline rounded-[5px] bg-transparent w-[39px] text-sm font-medium p-0 text-center">
