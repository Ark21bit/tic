   ...
   <div>
      ...
      <swiper :slidesPerView="'auto'" class="swiper-team w-full" :space-between="20">
          <SwiperSlide v-for="(item, key) in props.teams_info" :key="key">             
             <div v-html="item.media_avatar" class="[&>img]:object-cover [&>img]:w-full w-full [&>img]:h-full [&>img]:rounded-[5px] h-[292px] lg:h-[308px] mb-[15px]"></div>
...
<style type="text/tailwindcss">
    ...
    .swiper-team .swiper-slide{
        @apply w-fit lg:w-[285px] w-[270px]
    }
</style>
